...
scoreboard players operation @s tower_defense.coin -= #zombie tower_defense.coin

execute if score @s tower_defense.coin < #zombie tower_defense.coin run scoreboard players set #temp tower_defense.temp 0
