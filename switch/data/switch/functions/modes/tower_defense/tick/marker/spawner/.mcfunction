...
execute if entity @s[tag=mob.chicken] if score @s tower_defense.temp = #chicken_hatch_time tower_defense.temp run function switch:modes/tower_defense/tick/marker/spawner/chicken
